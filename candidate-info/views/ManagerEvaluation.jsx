...
class ManagerEvaluation extends Component {
		...
		handleOnChange(event) {
				...
				switch (event.target.name) {
						case "interviewerName2":
								...
								this.setState({
										interviewerName2: event.target.value
								})
								break;
						case "jobTitle":
		...
		handleSubmitManagerForm(e) {
				...
				managerRecord.createdBy = currentUser[0]._id;
				...
				if (managerRecord) {
						...
						this.setState({
								managerEvaluationData: newManagerEvaluationData
						});
						let url = "/candidateInfo";
						let roundUrl = url + '/CandidateRounds';
						$http.post(this.props.url + '/newManagerForm', managerRecord)
								.then(res => {
		...
		handleUpdateManagerForm(e, id, record) {
				...
				$http.put(`${iaUrl}/${id}`, updatedManagerRecord)
						.then(res => {
		...
		render() {
				...
				return ( <
						...
						<
						h2 className = "ia-form-title" > Manager Evaluation Form { !isOwner && "(Read-Only)"}  < /h2> < /
						Modal.Header > <
						Modal.Body >
						<
						...
						id = "manager_evaluation_detais_id" >
						<
						tbody >
						<
						tr >
						<
						td > < strong > Candidate Name < /strong></td > < td > {
								candidateFullname
						} < /td> <
						td > < strong > Candidate Id < /strong></td > < td > {
								candidateData.candidateID
						} < /td> <
						td > < strong > Interview Type < /strong></td > < td className = "interview-round" > {
								interViewToBeTaken
						} < /td> < /
						tr > <
						tr >
						<
						td > < strong > Interviewer < /strong> < /td><td>{createdUser.firstname + ' ' + createdUser.lastname}
						</td >
						<
						...
						autoComplete = "off"
						value = {
								currManagerObject.jobTitle || this.state.jobTitle
						}
						maxLength = "20"
						required onChange = {
								this.handleOnChange
						...
						<
						th colSpan = "2"
						className = "evaluation-criteria" > Evaluation Criteria < span className = "mandatory" > * < /span></th >
						<
						...
						className = "form-control"
						id = "ratings_id1"
						name = "clientOrientationRatings1"
						onChange = {
								this.handleOnChange
						}
						value = {
								currManagerObject.clientOrientationRatings1
						} >
						<
						...
						name = "clientOrientationComments1"
						id = "clientOrientationCommentsId1"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.clientOrientationComments1
						} > < /TextArea> < /
						td > <
						/tr> <
						tr >
						...
						id = "ratings_id2"
						name = "clientOrientationRatings2"
						onChange = {
								this.handleOnChange
						}
						value = {
								currManagerObject.clientOrientationRatings2
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "clientOrientationComments2"
						id = "clientOrientationCommentsId2"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.clientOrientationComments2
						} > < /TextArea> < /
						td > <
						/tr> <
						tr >
						...
						select required className = "form-control"
						id = "ratings_id3"
						name = "clientOrientationRatings3"
						onChange = {
								this.handleOnChange
						}
						value = {
								currManagerObject.clientOrientationRatings3
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "clientOrientationComments3"
						id = "clientOrientationCommentsId3"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.clientOrientationComments3
						} > < /TextArea> < /
						td > <
						/tr>
						...
						select required className = "form-control"
						id = "ratings_id4"
						name = "projectManagementRatings"
						onChange = {
								this.handleOnChange
						}
						value = {
								currManagerObject.projectManagementRatings
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "projectManagementComments"
						id = "projectManagementCommentsId"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.projectManagementComments
						} > < /TextArea> < /
						td > <
						/tr>
						...
						select required className = "form-control"
						id = "ratings_id5"
						name = "leadershipRatings"
						onChange = {
								this.handleOnChange
						}
						value = {
								currManagerObject.leadershipRatings
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						id = "leadershipCommentsId"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.leadershipComments
						} > < /TextArea> < /
						td > <
						/tr>
						...
						name = "communicationRatings"
						value = {
								currManagerObject.communicationRatings
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						id = "communicationCommentsId"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.communicationComments
						} > < /TextArea> < /
						td > <
						/tr>
						...
						value = {
								currManagerObject.domainRatings
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.domainComments
						} > < /TextArea> < /
						td > <
						/tr> <
						tr >
						...
						name = "technicalSolutionsRatings1"
						value = {
								currManagerObject.technicalSolutionsRatings1
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "technicalSolutionsComments1"
						id = "technicalSolutionsCommentsId1"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.technicalSolutionsComments1
						} > < /TextArea> < /
						td > <
						/tr>
						...
						name = "technicalSolutionsRatings2"
						value = {
								currManagerObject.technicalSolutionsRatings2
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "technicalSolutionsComments2"
						id = "technicalSolutionsCommentsId2"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.technicalSolutionsComments2
						} > < /TextArea> < /
						td > <
						/tr> <
						tr >
						...
						name = "technicalSolutionsRatings3"
						value = {
								currManagerObject.technicalSolutionsRatings3
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "technicalSolutionsComments3"
						id = "technicalSolutionsCommentsId3"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.technicalSolutionsComments3
						} > < /TextArea> < /
						td > <
						/tr> <
						tr >
						...
						name = "technicalSolutionsRatings4"
						value = {
								currManagerObject.technicalSolutionsRatings4
						} >
						<
						option value = "" > select < /option> <
						option > 0 - Not Applicaple < /option> <
						...
						name = "technicalSolutionsComments4"
						id = "technicalSolutionsCommentsId4"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.technicalSolutionsComments4
						} > < /TextArea> < /
						td > <
						/tr> < /
						tbody > <
						...
						center >
						<
						table className = "table table-bordered table-responsive remarks-width"
						id = "manager_evaluation_remarks_id" >
						<
						thead >
						<
						tr >
						...
						<
						td > < TextArea required rows = "2"
						cols = "50"
						onChange = {
								this.handleOnChange
						}
						name = "excellentRemark"
						id = "excellentRemarkId"
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.excellentRemark
						} > < /TextArea></td >
						<
						/tr> <
						tr >
						...
						placeholder = "Please enter the comments"
						value = {
								currManagerObject.averageRemark
						} > < /TextArea></td >
						<
						/tr> <
						tr >
					 ...
					 <
					 select required className = "form-control experience-width"
					 onChange = {
							 this.handleOnChange
					 }
					 name = "managerInterviewStatus"
					 id = "managerInterviewStatusId"
					 value = {
							 currManagerObject.managerInterviewStatus
					 } >
					 <
					 option value = "" > Select < /option> <
					 ...
					 /div>
						...
						div className = "margin-small" > {
								currManagerObject._id && isOwner &&
								<
								Button className = "move-right"
								onClick = {
										(e) => this.handleUpdateManagerForm(e, currManagerObject._id, managerEvaluationData)
								} > Update < /Button>
						} {
